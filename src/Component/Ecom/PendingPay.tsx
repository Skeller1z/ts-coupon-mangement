...
export default function PendingPay(props) {
  ...
  const Cancel = (order_id) => {
    MsgOKCancel("ยืนยันการลบ", "Delete?").then((res) => {
      if (res === "OK") {
        GetdataAPI("/api/MainSale/CancelOrder", { OrderId: order_id }).then(
          (res) => {
  ...
  const ContentSelectTopup = () => {
    return (
      <>
        <div className="grid grid-cols-12 gap-6 pb-[70px]">
          {TopupBy === "Cradit card" ? (
            <div
  ...
  return (
    <>
      {props.isLoading ? (
        ...
        <div className="grid col-span-12 p-3 bg-[#F6F9FF]">
          {props.SOheader.length === 0 ? (
                  ...
                  <div key={uuidv4()}>
                    ...
                    <div className="grid grid-cols-12 px-2 py-1  gap-3">
                      <div className="grid content-center col-span-12">
                        ...
                        {t("Total")} {NumberFormat(itemh.grand_total)}{" "}
                          THB
                        </div>
                      </div>
                      <div className="grid col-span-4  sm:col-span-4 md:col-span-4 lg:col-span-4 xl:col-span-4 content-center font-bold ">
      ...
      <div className="grid grid-cols-12">
        <div className="grid col-span-12">
          <Popup
            ...
            title={t("วิธีชำระเงิน/Payment Method")}
            resizeEnabled={true}
            height="100%"
            width="100%"
